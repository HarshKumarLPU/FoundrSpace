    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select id="role" name="role" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                <option value="customer">Customer (Looking to buy products/services)</option>
                <option value="startup_owner">Startup Owner (Looking to build/raise/sell)</option>
                <option value="investor">Investor (Looking for opportunities)</option>
                <option value="freelancer">Freelancer/Mentor (Looking to offer services)</option>
            </select>
