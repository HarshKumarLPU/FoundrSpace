<x-guest-layout>
    <div class="glass-panel p-8 sm:p-10 rounded-[2rem]" x-data="registerForm()">
        ...
        <div class="grid grid-cols-2 gap-4 mb-8">
            <a :href="`{{ route('socialite.redirect', 'google') }}?role=${role}`" class="flex justify-center items-center gap-3 w-full px-4 py-3 bg-slate-900 hover:bg-slate-800 border border-slate-700 hover:border-slate-500 rounded-xl text-sm font-bold text-white transition-all shadow-sm">
            ...
            <a :href="`{{ route('socialite.redirect', 'github') }}?role=${role}`" class="flex justify-center items-center gap-3 w-full px-4 py-3 bg-slate-900 hover:bg-slate-800 border border-slate-700 hover:border-slate-500 rounded-xl text-sm font-bold text-white transition-all shadow-sm">
