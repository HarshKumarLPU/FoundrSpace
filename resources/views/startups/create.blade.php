                ...
                <div class="p-8 text-gray-100">
                    <form method="POST" action="{{ route('startups.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="funding_goal" class="block mt-1 w-full bg-gray-900/50 border-gray-700 text-white focus:ring-cyan-500 focus:border-cyan-500" type="number" step="0.01" name="funding_goal" :value="old('funding_goal')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="funding_raised" class="block mt-1 w-full bg-gray-900/50 border-gray-700 text-white focus:ring-cyan-500 focus:border-cyan-500" type="number" step="0.01" name="funding_raised" :value="old('funding_raised')" />
